...
class ExceptionHandlerApiResponseTest extends IntegrationTestCase
{
    ...
    /**
     * The handler declares a content type before it knows whether the response it is about to build
     * is an error page or API output, so the renderer of the requested format has to replace it.
     */
